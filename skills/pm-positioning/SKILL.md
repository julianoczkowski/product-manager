...
yet, run `pm-personas` and `pm-market-problems` first (or gather them inline).
...
Then offer the next stage: turning these problems into prioritized **`pm-requirements`**.
